  ...
  return (
    <section className="lg:px-40 px-8 lg:py-16 py-8">
      <div className="grid justify-items-center ">
        <p className=" lg:w-96 text-3xl font-inter font-bold text-center lg:text-5xl">
          This is who we are
        </p>
      </div>
      <div className="grid lg:grid-cols-2 gap-8 lg:mt-8 mt-3">
        <div className="bg-[#99FF99] hover:bg-[#351c04] hover:text-white text-[#023002] rounded-3xl p-10 grid gap-4  ">
          ...
          <p className="text-center lg:text-lg text-sm  font-normal font-Inter">
        ...
        <div className="bg-[#023002] hover:bg-[#351c04] text-white rounded-3xl p-10 grid gap-4  ">
          ...
          <p className="text-center font-normal lg:text-base text-sm  font-Inter">
