...
const Belleful = () => {
  return (
    <section>
      <Navbar />
      <div className="lg:px-40 lg:py-10 py-8 px-14  lg:justify-normal justify-items-center bg-[#99FF99]">
        <div className="grid lg:grid-flow-col   lg:gap-4 gap-4">
          <div className=" lg:w-[600px] ">
            <img src={image} alt="" />
          </div>
          <div>
            <div className="bg-white lg:w-[600px]  lg:p-14 p-4 rounded-3xl grid gap-4">
              ...
              <p className="font-Inter text-sm">
                ...
                people in need, and highlighting the resilience and spirit of
                the Nigerian people. Launched on January 15th, 2017, the project
                has undertaken numerous community outreach programs across
                Nigeria.
              </p>
              <div className="grid gap-3">
                ...
                <ul>
                  <li className="font-Inter text-sm">
                    Conducted food interventions, clothing outreaches, and
                    medical missions in underserved communities across Northern
                    and Southern Nigeria.
                  </li>
                  <li>
                    {' '}
                    Provided relief materials to vulnerable populations,
                    including leper colonies, orphanages, and internally
                    displaced persons (IDPs) during the COVID-19 pandemic.
                  </li>
                  <li>
                    Successfully showcased the beauty, culture, and resilience
                    of the Nigerian people through various initiatives.
                  </li>
                </ul>
              </div>
              <div className="grid gap-3">
                ...
                <p className="font-Inter text-sm">
                  ...
                  provides tangible support to those in need. By highlighting
                  acts and the impact of kindness, the project aims to inspire
                  hope and foster a sense of community.
                </p>
              </div>
              <div className="grid gap-">
                ...
                <ul className="grid gap-2">
                  ...
                  <li className="font-Inter text-sm">
                    Promote volunteerism and community service among young
                    people.
                  </li>
                  <li className="font-Inter text-sm">
